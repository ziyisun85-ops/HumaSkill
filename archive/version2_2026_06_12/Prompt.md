...
- [ ] `python scripts/validation/validate_hermite.py` passes
- [ ] `python scripts/validation/validate_matcher.py` passes
- [ ] `python scripts/validation/validate_metrics.py` passes
